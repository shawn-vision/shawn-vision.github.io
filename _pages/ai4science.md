...
">
  ...
  <div style="flex: 1 1 330px; min-width: 280px;">
    ...
    <p style="margin:0 0 12px 0; font-size:1rem; line-height:1.65;">
      ...
      in fluid mechanics, heat transfer, sediment transport, and Earth-system dynamics —
      using AI not as a black box, but as a <strong>partner to theory and simulation</strong>.
    </p>
