...
Beyond sediment transport, I extend this approach to model **pier scour formation** using **machine learning–enhanced turbulence physics**. By unifying **TKE** and **shear stress budgets**, the model links **scour depth** to the dominant turbulent eddy scale — something previously inaccessible through traditional modeling.
